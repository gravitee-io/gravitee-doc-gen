...
func (s RawExampleSpec) TemplateFromRef() (GenTemplate, bool) {
...
func (s RawExampleSpec) GetProperties() core.Unstructured {
	return s.Properties
}

func (s RawExampleSpec) GetDisplay() Display {
	return s.Display
}

func (s RawExampleSpec) GetLanguage() Language {
	return s.Language
}
