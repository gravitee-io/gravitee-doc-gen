...
func (v *toEnvVisitor) OnObjectStart(object schema.Object, level int) {
	if v.inArray {
		return
	}
	if level == 0 {
...
func (v *toEnvVisitor) OnObjectEnd(object schema.Object, level int) {
	v.removeLastPaths()
}

func (v *toEnvVisitor) OnArrayStart(array schema.Array, level int) {
	v.inArray = true
	if level == 0 {
		v.currentSection = &envSection{
			Variables: make([]envVariable, 0),
...
func (v *toEnvVisitor) OnArrayItem(array schema.Array, value schema.Value, level int) {
...
func (v *toEnvVisitor) OnArrayEnd(array schema.Array, level int) {
	v.inArray = false
}

func (v *toEnvVisitor) OnAttribute(attribute schema.Attribute, level int) {
